...
const candado_img = document.querySelector(".candado_img");
...
candado_img.addEventListener("click",function (e){
...
const candado_img2 = document.querySelector(".candado_img2");
...
candado_img2.addEventListener("click",function (e){
